...
//                _src.animationType = (DOTweenAnimationType)EditorGUILayout.EnumPopup(_src.animationType, EditorGUIUtils.popupButton);
            ...
            case DOTweenAnimationType.Move:
                    ...
                    if ( _src.isFrom == true)
                    {
                        ...
                        {
                            _src.endValueV3 = _src.transform.position;
                            _src.defaultValueV3 = _src.transform.position;
                        }

                    }
                    else if(_src.isFrom==false)
                    {
                        if(GUILayout.Button("Recording",GUILayout.Width(100)))
                            _src.endValueV3 = _src.transform.position;
                        if(GUILayout.Button("Replacement",GUILayout.Width(100)))
                            _src.transform.position = _src.defaultValueV3;
                    }
            ...
            case DOTweenAnimationType.LocalMove:
                GUIEndValueV3();
                    ...
                    if ( _src.isFrom == true)
                    {
                        if (GUILayout.Button("Recording", GUILayout.Width(100)))
                        {
                            _src.endValueV3 = _src.transform.localPosition;
                            _src.defaultValueV3 = _src.transform.localPosition;
                        }
                    ...
                    else if(_src.isFrom==false)
                    {
                        if(GUILayout.Button("Recording",GUILayout.Width(100)))
                            _src.endValueV3 = _src.transform.localPosition;
                        if(GUILayout.Button("Replacement",GUILayout.Width(100)))
                            _src.transform.localPosition = _src.defaultValueV3;
                    }
            ...
            case DOTweenAnimationType.Rotate:
                    if (_src.GetComponent<Rigidbody2D>()) GUIEndValueFloat();
                        ...
                        if ( _src.isFrom == true)
                        {
                            if (GUILayout.Button("Recording", GUILayout.Width(100)))
                            {
                                _src.endValueV3 = _src.transform.rotation.eulerAngles;
                                _src.defaultValueV3 = _src.transform.rotation.eulerAngles;
                            }
                        ...
                        else if(_src.isFrom==false)
                        {
                            if(GUILayout.Button("Recording",GUILayout.Width(100)))
                                _src.endValueV3 = _src.transform.rotation.eulerAngles;
                            if(GUILayout.Button("Replacement",GUILayout.Width(100)))
                                _src.transform.rotation = Quaternion.Euler(_src.defaultValueV3);
                        }
                ...
                if (_src.GetComponent<Rigidbody2D>()) GUIEndValueFloat();
                    ...
                    GUIEndValueV3();
                        ...
                        if ( _src.isFrom == true)
                        {
                            if (GUILayout.Button("Recording", GUILayout.Width(100)))
                            {
                                _src.endValueV3 = _src.transform.localRotation.eulerAngles;
                                _src.defaultValueV3 = _src.transform.localRotation.eulerAngles;
                            }
                        ...
                        else if(_src.isFrom==false)
                        {
                            if(GUILayout.Button("Recording",GUILayout.Width(100)))
                                _src.endValueV3 = _src.transform.localRotation.eulerAngles;
                            if(GUILayout.Button("Replacement",GUILayout.Width(100)))
                                _src.transform.localRotation = Quaternion.Euler(_src.defaultValueV3);
                        }
                ...
                case DOTweenAnimationType.Scale:
                    if (!_src.optionalBool0)
                    {
                        ...
                        if (_src.isFrom == true)
                        {
                            if (GUILayout.Button("Recording", GUILayout.Width(100)))
                            {
                                _src.endValueV3 = _src.transform.localScale;
                                _src.defaultValueV3 = _src.transform.localScale;
                            }
                        ...
                        else if (_src.isFrom == false)
                        {
                            if (GUILayout.Button("Recording", GUILayout.Width(100)))
                                _src.endValueV3 = _src.transform.localScale;
                            if (GUILayout.Button("Replacement", GUILayout.Width(100)))
                                _src.transform.localScale = _src.defaultValueV3;
                        }
        ...
        {
            if (GUILayout.Button(_src.isFrom ? "FROM" : "TO", EditorGUIUtils.sideBtStyle, GUILayout.Width(60))) _src.isFrom = !_src.isFrom;
            GUILayout.Space(16);
        }
    }
}